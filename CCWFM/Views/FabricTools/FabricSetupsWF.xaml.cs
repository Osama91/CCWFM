...
{
    public partial class FabricSetupsWF
    {
        ...
        private FabricSetupsWFViewModel _fabAttrsViewModelObj;

        public FabricSetupsWFViewModel FabAttrsViewModelObj
        {
            get { return _fabAttrsViewModelObj; }
            set { _fabAttrsViewModelObj = value; }
        }

        public FabricSetupsWF()
        {
            InitializeComponent();
            FabAttrsViewModelObj = new FabricSetupsWFViewModel();
