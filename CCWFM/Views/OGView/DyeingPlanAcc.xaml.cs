...
{
    public partial class DyeingPlanAcc
    {
        private readonly DyeingPlanAccViewModel _dyedPlanViewModel = new DyeingPlanAccViewModel();
        private readonly DyeingOrderViewModel _dyedOrderViewModel = new DyeingOrderViewModel();

        public DyeingPlanAcc()
        {
            InitializeComponent();
        ...
        private void Delete_Click(object sender, RoutedEventArgs e)
        {
            ...
            var parent = btnDelete.Parent as StackPanel;

            if (parent.Children.OfType<TextBlock>().FirstOrDefault().Tag != null)
            {
                //   int IserialInt = int.Parse(Parent.Children.OfType<TextBlock>().FirstOrDefault().Tag.ToString());
                //   webService.DeleteDyeingRowAsync(IserialInt);
            }
        }
        ...
        private void ImgClearBrand_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            CbBrand.SelectedIndex = -1;
        }

        private void ImgClearSeason_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            CbSeason.SelectedIndex = -1;
        }

        private void ImgClearLocation_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
        ...
        private void btnPrintTransaction_Click(object sender, RoutedEventArgs e)
        {
            ...
            para.Add(_dyedOrderViewModel.SelectedMainDetails.TransId.ToString());
            para.Add(_dyedOrderViewModel.SelectedMainDetails.DyeingProductionOrder.ToString());
        ...
        {
            //  _dyedOrderPlanViewModel.SearchHeader();
        ...
        private void btnDeleteOrderPlan_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (r == MessageBoxResult.OK)
            {
                //   _dyedOrderPlanViewModel.DeleteOrderPlan();
            }
        }

        private void btnAddNewMainOrderPlanDetails_Clicked(object sender, RoutedEventArgs e)
        {
            //_dyedOrderPlanViewModel.DyeingOrderPlanMainDetailList.Add(new TblDyeingOrderPlansMainDetailViewModel()
            //{
            //    DyeingProductionOrderPlan = _dyedOrderPlanViewModel.DyeingOrderPlanHeader.DyeingProductionOrderPlan,
            //    Saved = false,
            //    TransactionDate = _dyedOrderPlanViewModel.DyeingOrderPlanHeader.TransactionDate,
            //});
        }

        private void btnDeleteOrderPlanMainDetails_Click(object sender, RoutedEventArgs e)
        {
            var r =
           MessageBox
           .Show("You are about to delete a Dyed OrderPlan Main Detail permanently!!\nPlease note that this action cannot be undone!"
                   , "Delete", MessageBoxButton.OKCancel);
            if (r == MessageBoxResult.OK)
            {
                try
                {
                    //_dyedPlanViewModel.DeleteMainDetailsOrderPlan();
                }
                catch (Exception ex)
                {
                    throw ex;
        ...
        private void btnAddNewOrderPlanDetails_Clicked(object sender, RoutedEventArgs e)
        {
            //if (_dyedOrderPlanViewModel.SelectedMainDetails.TransactionType == 0)
            //{
            //    _dyedOrderPlanViewModel.SelectedMainDetails.TblDyeingOrderPlanDetails.Add(new TblDyeingOrderPlanDetailsViewModel()
            //    {
            //        DyeingProductionOrderPlan = _dyedOrderPlanViewModel.DyeingOrderPlanHeader.DyeingProductionOrderPlan,
            //        TransactionType = _dyedOrderPlanViewModel.SelectedMainDetails.TransactionType,
            //        TransId = _dyedOrderPlanViewModel.SelectedMainDetails.TransId,
            //    });
            //}
            //else
            //{
            //    var childWindow = new RecieveDyedFabric(_dyedOrderPlanViewModel);
            //    childWindow.Show();
            //}
        }

        private void btnDeleteOrderPlanDetails_Click(object sender, RoutedEventArgs e)
        {
            //dyedOrderPlanViewModel.DeleteDetailsOrderPlan();
            _dyedPlanViewModel.HeaderViewModel.DyeingViewModelList.Remove(_dyedPlanViewModel.SelectedRow);
        }

        private void btnDyeingOrderPlanServices_Click(object sender, RoutedEventArgs e)
        {
            //     _dyedPlanViewModel.DyeingOrderPlanServices();
        }
