...
{
    public partial class ExcuseRules
    {
        private readonly ExcuseRuleViewModel _viewModel;

        public ExcuseRules()
        {
            InitializeComponent();
         //   browserControl.Source = new Uri("https://msdn.microsoft.com/fr-fr/library/ff457752(v=vs.95).aspx");
            _viewModel = (ExcuseRuleViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblExcuseRuleViewModel);
            }
