...
namespace CCWFM.Views.OGView
{
    ...
    {
        private readonly PeriodLockViewModel _viewModel;

        public PeriodLock()
        {
            InitializeComponent();

            _viewModel = (PeriodLockViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblPeriodLockModel);
            }
