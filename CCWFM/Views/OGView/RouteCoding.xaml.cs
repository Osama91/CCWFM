...
{
    public partial class RouteCoding
    {
        private readonly RouteCodingViewModel _viewModel;

        public RouteCoding()
        {
            InitializeComponent();
            _viewModel = (RouteCodingViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblRouteGroupViewModel);
            }
        ...
        private void DetailGrid_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Delete)
            {
                ...
                {
                    _viewModel.SelectedDetailRows.Add(row as TblRouteViewModel);
                }
