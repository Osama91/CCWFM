...
{
    public partial class UserCheckListChildWindow
    {
        private readonly UserCheckListViewModel _viewModel;

        public UserCheckListChildWindow(int iserial)
        {
            InitializeComponent();
            _viewModel =new UserCheckListViewModel();
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblUserCheckListViewModel);
            }
