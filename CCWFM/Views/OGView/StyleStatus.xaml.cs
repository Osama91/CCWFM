...
{
    public partial class StyleStatus
    {
        private readonly StyleStatusViewModel _viewModel;

        public StyleStatus()
        {
            InitializeComponent();
            _viewModel = (StyleStatusViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblStyleStatusViewModel);
            }
