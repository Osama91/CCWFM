...
{
    public partial class ItemPerBarcode
    {
     //   private readonly ItemPerBarcodeViewModel _viewModel;

        public ItemPerBarcode()
        {
            InitializeComponent();
     //       _viewModel = (ItemPerBarcodeViewModel)LayoutRoot.DataContext;
    //        DataContext = _viewModel;
        ...
        //    {
        //        _viewModel.SelectedMainRows.Add(row as TblItemPerBarcodeViewModel);
        //    }
