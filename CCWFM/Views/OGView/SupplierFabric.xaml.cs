...
namespace CCWFM.Views.OGView
{
    ...
    {
        private readonly SupplierFabricViewModel _viewModel;

        public SupplierFabric()
        {
            InitializeComponent();
            _viewModel = (SupplierFabricViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblSupplierFabricViewModel);
            }
