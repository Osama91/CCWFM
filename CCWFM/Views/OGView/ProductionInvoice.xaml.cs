...
{
    public partial class ProductionInvoice
    {   
        private readonly ProductionInvoiceViewModel _viewModel = new ProductionInvoiceViewModel();
        ...
        private void ClearScreen()
        {
            ...
            _viewModel.TransactionHeader = new TblProductionInvoiceHeaderModel();
        }
