...
{
    public partial class PurchaseBudget
    {
        private readonly PurchaseBudgetViewModel _viewModel;

        public PurchaseBudget()
        {
            InitializeComponent();
            _viewModel = (PurchaseBudgetViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblPurchaseBudgetHeaderViewModel);
            }
        ...
        private void DetailGrid_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Delete)
            {
                ...
                {
                    _viewModel.SelectedDetailRows.Add(row as TblPurchaseBudgetDetailViewModel);
                }
