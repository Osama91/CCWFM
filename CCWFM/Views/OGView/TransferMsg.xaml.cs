...
namespace CCWFM.Views.OGView
{
    ...
    {
        private readonly TransferMsgViewModel _viewModel;

        public TransferMsg()
        {
            InitializeComponent();
            _viewModel = (TransferMsgViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblTransferMsgViewModel);
            }
