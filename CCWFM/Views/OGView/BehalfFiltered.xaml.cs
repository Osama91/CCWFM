...
{
    public partial class BehalfFiltered
    {
        private readonly BehalfFilteredViewModel _viewModel;

        public BehalfFiltered()
        {
            InitializeComponent();
            _viewModel = (BehalfFilteredViewModel)LayoutRoot.DataContext;
