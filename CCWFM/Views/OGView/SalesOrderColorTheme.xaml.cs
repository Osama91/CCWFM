...
{
    public partial class SalesOrderColorTheme
    {
        private readonly SalesOrderColorThemeViewModel _viewModel;

        public SalesOrderColorTheme()
        {
            InitializeComponent();
            _viewModel = (SalesOrderColorThemeViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add((TblSalesOrderColorThemeViewModel)row);
            }
        ...
        private void MainGrid_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Delete)
            {
                ...
                foreach (var row in MainGrid.SelectedItems)
                {
                    _viewModel.SelectedMainRows.Add(row as TblSalesOrderColorThemeViewModel);
                }
