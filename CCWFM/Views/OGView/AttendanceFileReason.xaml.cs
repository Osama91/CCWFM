...
{
    public partial class AttendanceFileReason
    {
        private readonly AttendanceFileReasonViewModel _viewModel;

        public AttendanceFileReason()
        {
            InitializeComponent();
            _viewModel = (AttendanceFileReasonViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblAttendanceFileReasonViewModel);
            }
