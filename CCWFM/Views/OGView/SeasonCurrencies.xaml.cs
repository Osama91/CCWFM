...
{
    public partial class SeasonCurrencies
    {
        private readonly SeasonCurrenciesViewModel _viewModel;

        public SeasonCurrencies()
        {
            InitializeComponent();
            _viewModel = (SeasonCurrenciesViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblSeasonCurrenciesViewModel);
            }
