...
{
    public partial class DyeingOrderInvoice
    {
        private readonly DyeingOrderInvoiceViewModel _viewModel = new DyeingOrderInvoiceViewModel();//PermissionItemName.DyeingOrderInvoice);
        ...
        private void ClearScreen()
        {
            ...
            _viewModel.SelectedMainRow = new TblDyeingOrderInvoiceHeaderViewModel();
        }
