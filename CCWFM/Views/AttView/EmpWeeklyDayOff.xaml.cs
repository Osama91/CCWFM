...
{
    public partial class EmpWeeklyDayOff
    {
        private readonly EmpWeeklyDayOffViewModel _viewModel;

        public EmpWeeklyDayOff()
        {
            InitializeComponent();

            _viewModel = (EmpWeeklyDayOffViewModel)LayoutRoot.DataContext;
        ...
        private void MainGrid_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Delete)
            {
                ...
                {
                    _viewModel.SelectedMainRows.Add(row as TblEmpWeeklyDayOffViewModel);
                }
