...
namespace CCWFM.Views.Gl
{
    ...
    {
        private readonly MarkupGroupViewModel _viewModel;

        public MarkupGroup()
        {
            InitializeComponent();
            _viewModel = (MarkupGroupViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblMarkupGroupViewModel);
            }
