...
{
    public partial class CashDepositeType 
    {
        private readonly CashDepositeTypeViewModel _viewModel;

        public CashDepositeType()
        {
            InitializeComponent();
            _viewModel = (CashDepositeTypeViewModel)LayoutRoot.DataContext;
        ...
        private void MainGrid_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Delete)
            {
                ...
                {
                    _viewModel.SelectedMainRows.Add((TblCashDepositeTypeViewModel)row);
                }
