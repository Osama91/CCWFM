...
{
    public partial class GlRuleJob
    {
        private readonly GlRuleJobViewModel _viewModel;

        public GlRuleJob()
        {
            InitializeComponent();
            _viewModel = (GlRuleJobViewModel) LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add((TblGlRuleJobViewModel)row);
            }
