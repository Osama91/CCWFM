...
namespace CCWFM.Views.Gl
{
    ...
    {
        private readonly CostCenterViewModel _viewModel;

        public CostCenter()
        {
            InitializeComponent();
            _viewModel = (CostCenterViewModel) LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add((TblCostCenterViewModel)row);
            }
        ...
        private void MainGrid_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                _viewModel.SaveOldRow(variable as TblCostCenterViewModel);
            }
        }
    }
}