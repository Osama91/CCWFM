...
namespace CCWFM.Views.Gl
{
    public partial class GlRule
    {
        ...
        {
            InitializeComponent();
            _viewModel = (GlRuleViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblGlRuleHeaderViewModel);
            }
        ...
        private void MainGrid_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (MainGrid.SelectedItem != null)
            {
                ...
                {
                    _viewModel.SaveOldRow(variable as TblGlRuleHeaderViewModel);
                }
            }
        }
        ...
        private void DetailGrid_KeyUp(object sender, KeyEventArgs e)
        {
             ...
             else if (e.Key == Key.Delete && ModifierKeys.Shift == Keyboard.Modifiers)
            {
                ...
                {
                    _viewModel.SelectedDetailRows.Add(row as TblGlRuleMainDetailViewModel);
                }
        ...
        private void DetailGrid_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            foreach (var variable in e.RemovedItems)
            {
                _viewModel.SaveOldDetailRow(variable as TblGlRuleMainDetailViewModel );
            }
        }

        private void BtnDetails_OnClick(object sender, RoutedEventArgs e)
        {
            var child = new GlRuleDetailChildWindow(_viewModel);
            child.Show();
        }
    }
}