...
{
    public partial class GlExpensis
    {
        private readonly GlExpensisViewModel _viewModel;

        public GlExpensis()
        {
            InitializeComponent();
            _viewModel = (GlExpensisViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add((TblGlExpensisViewModel)row);
            }
        ...
        private void MainGrid_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                _viewModel.SaveOldRow(variable as TblGlExpensisViewModel);
            }
        }
