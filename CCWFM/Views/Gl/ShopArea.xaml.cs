...
namespace CCWFM.Views.Gl
{
    public partial class ShopArea
    {
        ...
        {
            InitializeComponent();
            _viewModel = (ShopAreaViewModel) LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add((TblshopareaModel)row);
            }
        ...
        private void MainGrid_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                _viewModel.SaveOldRow(variable as TblshopareaModel);
            }
        }
        ...
        private void btnShopArea_Click(object sender, RoutedEventArgs e)
        {
            _viewModel.ShowLinkChildWindow();
        }
    }
}