...
{
    public partial class GlGenEntity
    {
        private readonly GlGenEntityViewModel _viewModel;

        public GlGenEntity()
        {
            InitializeComponent();
            _viewModel = (GlGenEntityViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblGlGenEntityGroupViewModel);
            }
        ...
        private void MainGrid_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (MainGrid.SelectedItem != null)
            {
                ...
                {
                    _viewModel.SaveOldRow(variable as TblGlGenEntityGroupViewModel);
                }
            }
        }
        ...
        private void DetailGrid_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Delete && ModifierKeys.Shift == Keyboard.Modifiers)
            {
                ...
                {
                    _viewModel.SelectedDetailRows.Add(row as TblGlGenEntityViewModel);
                }
        ...
        private void DetailGrid_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            foreach (var variable in e.RemovedItems)
            {
                _viewModel.SaveOldDetailRow(variable as TblGlGenEntityViewModel);
            }
        }
