...
{
    public partial class ClosingPosting
    {
        private readonly ClosingPostingViewModel _viewModel;

        public ClosingPosting()
        {
            InitializeComponent();
            _viewModel = (ClosingPostingViewModel)LayoutRoot.DataContext;
