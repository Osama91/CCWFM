...
namespace CCWFM.Views.Gl
{
    ...
    {
        private readonly MethodOfPaymentViewModel _viewModel;

        public MethodOfPayment()
        {
            InitializeComponent();
            _viewModel = (MethodOfPaymentViewModel) LayoutRoot.DataContext;
        ...
        private void MainGrid_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Delete)
            {
                ...
                {
                    _viewModel.SelectedMainRows.Add((TblMethodOfPaymentViewModel) row);
                }
        ...
        private void MainGrid_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                _viewModel.SaveOldRow(variable as TblMethodOfPaymentViewModel);
            }
