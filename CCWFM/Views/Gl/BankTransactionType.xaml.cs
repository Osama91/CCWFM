...
namespace CCWFM.Views.Gl
{
    ...
    {
        private readonly BankTransactionTypeViewModel _viewModel;

        public BankTransactionType()
        {
            InitializeComponent();
            _viewModel = (BankTransactionTypeViewModel)LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add(row as TblBankTransactionTypeViewModel);
            }
