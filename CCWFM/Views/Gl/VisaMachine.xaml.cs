...
{
    public partial class VisaMachine 
    {
        private readonly VisaMachineViewModel _viewModel;

        public VisaMachine()
        {
            InitializeComponent();
            _viewModel = (VisaMachineViewModel)LayoutRoot.DataContext;
        ...
        private void MainGrid_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Delete)
            {
                ...
                {
                    _viewModel.SelectedMainRows.Add((TblVisaMachineViewModel)row);
                }
