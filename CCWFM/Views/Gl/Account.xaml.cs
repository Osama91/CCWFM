...
namespace CCWFM.Views.Gl
{
	public partial class Account
	{
		...
		{
			InitializeComponent();
			_viewModel = (AccountViewModel) LayoutRoot.DataContext;
		...
		private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
		{
			...
			{
				_viewModel.SelectedMainRows.Add((TblAccountViewModel)row);
			}
		...
		private void MainGrid_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
		{
			...
			{
				_viewModel.SaveOldRow(variable as TblAccountViewModel);
			}
		}
		...
		private void BtnInterval_OnClick(object sender, RoutedEventArgs e)
		{
			_viewModel.GetDetailData();
			var child = new  AccountIntervalChildWindow(_viewModel);
	   ...
	   //     _viewModel.GetFullMainData();
			
			MainGrid.ExportExcel("Acccount");
