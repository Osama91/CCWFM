...
{
    public partial class AccountIntervalChildWindow
    {
        private readonly AccountViewModel _viewModel;

        public AccountIntervalChildWindow(AccountViewModel viewModel)
        {
            InitializeComponent();
        ...
        private void DetailGrid_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Delete)
            {
                ...
                {
                    _viewModel.SelectedDetailRows.Add(row as TblAccountIntervalViewModel);
                }
