...
{
    public partial class GlCashTransactionChildWindow
    {
        ...
        {
            _viewModel.SelectedMainRow = RecieveHeaderDataGrid.SelectedItem as TblGlCashTransactionHeaderViewModel;
        ...
        //private void BtnprintCash_OnClick(object sender, RoutedEventArgs e)
        //{
        //    _viewModel.Glclient.PrintCheckAsync((int)_viewModel.SelectedDetailRow.TblBankCash, LoggedUserInfo.DatabasEname);
