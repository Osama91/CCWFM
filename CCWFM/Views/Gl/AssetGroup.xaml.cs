...
namespace CCWFM.Views.Gl
{
    ...
    {
        private readonly AssetGroupViewModel _viewModel;

        public AssetGroup()
        {
            InitializeComponent();
            _viewModel = (AssetGroupViewModel) LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add((TblAssetGroupViewModel)row);
            }
