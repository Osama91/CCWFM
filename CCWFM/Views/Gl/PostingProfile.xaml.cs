...
{
    public partial class PostingProfile
    {
        ...
        {
            InitializeComponent();
            _viewModel = (PostingProfileHeaderViewModel) LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add((TblPostingProfileHeaderViewModel)row);
            }
        ...
        {
            var child = new PostingProfileDetailChildWindow(_viewModel);
            child.Show();
        }
        private void MainGrid_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                _viewModel.SaveOldRow(variable as TblPostingProfileHeaderViewModel);
            }
        }
