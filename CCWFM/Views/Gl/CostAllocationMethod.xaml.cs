...
namespace CCWFM.Views.Gl
{
    ...
    {
        private readonly CostAllocationMethodViewModel _viewModel;

        public CostAllocationMethod()
        {
            InitializeComponent();
            _viewModel = (CostAllocationMethodViewModel) LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add((TblCostAllocationMethodViewModel)row);
            }
