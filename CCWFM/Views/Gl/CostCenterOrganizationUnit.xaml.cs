...
{
    public partial class CostCenterOrganizationUnit
    {
        private readonly CostCenterOrganizationUnitViewModel _viewModel;

        public CostCenterOrganizationUnit()
        {
            InitializeComponent();
            _viewModel = (CostCenterOrganizationUnitViewModel) LayoutRoot.DataContext;
        ...
        private void BtnDeleteMainRow_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _viewModel.SelectedMainRows.Add((TblCostCenterOrganizationUnitViewModel)row);
            }
