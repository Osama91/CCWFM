...
namespace CCWFM.Views.Gl
{
    public partial class Journal
    {
        ...
        {
            InitializeComponent();
            _viewModel = (JournalViewModel)LayoutRoot.DataContext;
        ...
        private void MainGrid_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Delete && ModifierKeys.Shift == Keyboard.Modifiers)
            {
                ...
                {
                    _viewModel.SelectedMainRows.Add((TblJournalViewModel)row);
                }
        ...
        private void MainGrid_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                _viewModel.SaveOldRow(variable as TblJournalViewModel);
            }
        }
    }
}