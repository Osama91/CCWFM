...
namespace CCWFM.UserControls
{
    ...
    {
        private readonly SearchJournalUserControl _userControl;
        private readonly SearchJournalViewModel _viewModel = new SearchJournalViewModel();

        public SearchJournal(SearchJournalUserControl searchJournalUserControl)
        {
            InitializeComponent();
            DataContext = _viewModel;
            _userControl = searchJournalUserControl;
        }

        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            _userControl.SearchPerRow = MainGrid.SelectedItem as TblJournal;
            DialogResult = true;
        }
