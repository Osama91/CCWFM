...
{
    public partial class SearchRetailSeasonChild
    {
        private readonly SearchRetailSeasonViewModel _viewModel = new SearchRetailSeasonViewModel();
        private readonly SearchRetailSeason _userControl;

        public SearchRetailSeasonChild(SearchRetailSeason searchEmployeeUserControl)
        {
            InitializeComponent();
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _userControl.SearchPerRow = MainGrid.SelectedItem as TblSeason;
                DialogResult = true;
            }
        }
