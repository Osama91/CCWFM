...
{
    public partial class SearchStyleFabricCompositionChild
    {
        private readonly SearchStyleFabricCompositionViewModel _viewModel = new SearchStyleFabricCompositionViewModel();
        private readonly SearchStyleFabricComposition _userControl;

        public SearchStyleFabricCompositionChild(SearchStyleFabricComposition searchEmployeeUserControl)
        {
            InitializeComponent();
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                //  _userControl.SearchPerRow = MainGrid.SelectedItem as TblSupplierFabric;
                DialogResult = true;
            }
        }
