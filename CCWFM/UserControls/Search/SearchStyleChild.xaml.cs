...
{
    public partial class SearchStyleChild
    {
        private readonly SearchStyleViewModel _viewModel = new SearchStyleViewModel();
        private readonly SearchStyle _userControl;

        public SearchStyleChild(SearchStyle searchEmployeeUserControl)
        {
            InitializeComponent();
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _userControl.SearchPerRow = MainGrid.SelectedItem as TblStyle;
                DialogResult = true;
            }
        }
