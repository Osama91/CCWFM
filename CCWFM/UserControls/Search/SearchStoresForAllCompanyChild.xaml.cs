...
{
    public partial class SearchStoresForAllCompanyChild
    {
        private readonly SearchStoresForAllCompanyViewModel _viewModel = new SearchStoresForAllCompanyViewModel();
        private readonly SearchStoresForAllCompany _userControl;

        public SearchStoresForAllCompanyChild(SearchStoresForAllCompany SearchStoreForAllCompanyloyeeUserControl)
        {
            InitializeComponent();
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _userControl.SearchPerRow = MainGrid.SelectedItem as StoreForAllCompany;
                DialogResult = true;
            }
        }
