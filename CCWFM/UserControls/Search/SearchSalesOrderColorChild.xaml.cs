...
{
    public partial class SearchSalesOrderColorChild
    {
        private readonly SearchSalesOrderColorViewModel _viewModel = new SearchSalesOrderColorViewModel();
        private readonly SearchSalesOrderColor _userControl;

        public SearchSalesOrderColorChild(SearchSalesOrderColor searchEmployeeUserControl)
        {
            InitializeComponent();
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _userControl.SearchPerRow = MainGrid.SelectedItem as TblSalesOrderColor;
                DialogResult = true;
            }
        }
