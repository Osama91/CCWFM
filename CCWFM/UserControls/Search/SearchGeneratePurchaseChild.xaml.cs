...
{
    public partial class SearchGeneratePurchaseChild
    {
        private readonly SearchGeneratePurchaseViewModel _viewModel = new SearchGeneratePurchaseViewModel();
        private readonly SearchGeneratePurchase _userControl;

        public SearchGeneratePurchaseChild(SearchGeneratePurchase searchEmployeeUserControl)
        {
            InitializeComponent();
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _userControl.SearchPerRow = MainGrid.SelectedItem as PurchasePlanService.TblGeneratePurchaseHeader;
                DialogResult = true;
            }
        }
