...
{
    public partial class SearchGroupsChild
    {
        private readonly SearchGroupsViewModel _viewModel = new SearchGroupsViewModel();
        private readonly SearchGroups _userControl;

        public SearchGroupsChild(SearchGroups searchEmployeeUserControl)
        {
            InitializeComponent();
            DataContext = _viewModel;
            _userControl = searchEmployeeUserControl;
            _viewModel.TableName = searchEmployeeUserControl.TableName;
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _userControl.SearchPerRow = MainGrid.SelectedItem as TblGROUP1;
                DialogResult = true;
            }
        }
