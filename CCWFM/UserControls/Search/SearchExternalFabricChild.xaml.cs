...
{
    public partial class SearchExternalFabricChild
    {
        private readonly SearchExternalFabricViewModel _viewModel = new SearchExternalFabricViewModel();
        private readonly SearchExternalFabric _userControl;

        public SearchExternalFabricChild(SearchExternalFabric searchEmployeeUserControl)
        {
            InitializeComponent();
