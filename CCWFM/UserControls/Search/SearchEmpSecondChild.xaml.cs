...
{
    public partial class SearchEmpSecondChild
    {
        private readonly SearchEmpSecondViewModel _viewModel = new SearchEmpSecondViewModel();
        private readonly SearchEmpSecond _userControl;

        public SearchEmpSecondChild(SearchEmpSecond searchEmployeeUserControl)
        {
            InitializeComponent();
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _userControl.SearchPerRow = MainGrid.SelectedItem as EmployeesView;
                DialogResult = true;
            }
        }
