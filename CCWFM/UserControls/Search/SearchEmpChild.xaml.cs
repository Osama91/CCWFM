...
{
    public partial class SearchEmpChild
    {
        private readonly SearchEmpViewModel _viewModel = new SearchEmpViewModel();
        private readonly SearchEmp _userControl;

        public SearchEmpChild(SearchEmp searchEmployeeUserControl)
        {
            InitializeComponent();
