...
{
    public partial class SearchColorChild
    {
        private readonly SearchColorViewModel _viewModel = new SearchColorViewModel();
        private readonly SearchColor _userControl;

        public SearchColorChild(SearchColor searchEmployeeUserControl)
        {
            InitializeComponent();
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _userControl.SearchPerRow = MainGrid.SelectedItem as TblColor;
                DialogResult = true;
            }
        }
