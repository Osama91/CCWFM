...
{
    public partial class SearchStoresChild
    {
        private readonly SearchStoresViewModel _viewModel = new SearchStoresViewModel();
        private readonly SearchStores _userControl;
