...
{
    public partial class SearchItemDownLoadDefChild
    {
        private readonly ItemDownLoadDefViewModel _viewModel = new ItemDownLoadDefViewModel();
        private readonly SearchItemDownloadDef _userControl;

        public SearchItemDownLoadDefChild(SearchItemDownloadDef searchItemDownLoadDefloyeeUserControl)
        {
            InitializeComponent();
            DataContext = _viewModel;
            _userControl = searchItemDownLoadDefloyeeUserControl;
        }
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _userControl.SearchPerRow = MainGrid.SelectedItem as TblItemDownLoadDef;
                DialogResult = true;
            }
        }
