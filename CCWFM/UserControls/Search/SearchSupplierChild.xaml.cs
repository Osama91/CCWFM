...
{
    public partial class SearchSupplierChild
    {
        private readonly SearchSupplierViewModel _viewModel = new SearchSupplierViewModel();
        private readonly SearchSupplier _userControl;

        public SearchSupplierChild(SearchSupplier searchEmployeeUserControl)
        {
            InitializeComponent();
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _userControl.SearchPerRow = MainGrid.SelectedItem as TBLsupplier;
                DialogResult = true;
            }
        }
