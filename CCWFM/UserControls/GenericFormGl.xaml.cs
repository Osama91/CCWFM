...
{
    public partial class GenericFormGl
    {
        private readonly GenericViewModelCollectionGl _viewModel;
        ...
        public GenericFormGl(string tablEname, string userJobsFormGl, PermissionItemName factoryGroupFormGl)
        {
            InitializeComponent();
            _viewModel = new GenericViewModelCollectionGl(tablEname, factoryGroupFormGl);
        ...
        private void BtnImport_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (oFile.ShowDialog() == true)
            {
                ...
                for (int i = sheet.Cells.FirstRowIndex + 1; i < sheet.Cells.LastRowIndex; i++)
                {
                    ...
                    {
                        Code = sheet.Cells[i, code].StringValue.Trim(),
                        Aname = sheet.Cells[i, aname].StringValue.Trim(),
                        Ename = sheet.Cells[i, ename].StringValue.Trim()
                    };
