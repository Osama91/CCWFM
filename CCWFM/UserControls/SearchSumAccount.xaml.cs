...
{
    public partial class SearchSumAccount
    {
        private readonly SearchSumAccountUserControl _userControl;
        private readonly SearchAccountViewModel _viewModel = new SearchAccountViewModel();

        public SearchSumAccount(SearchSumAccountUserControl searchAccountUserControl)
        {
            InitializeComponent();
