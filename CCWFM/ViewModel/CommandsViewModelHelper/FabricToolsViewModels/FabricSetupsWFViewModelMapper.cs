...
{
    internal static class FabricSetupsWFViewModelMapper
    {
        #region [ Methods ]

        public static _Proxy.tbl_FabricAttriputes MapToModelObject(FabricSetupsWFViewModel objectToBeMapped)
        {
        ...
        public static void MapToViewModelObject(FabricSetupsWFViewModel temp, _Proxy.tbl_FabricAttriputes objectToBeMapped)
        {
        ...
        public static _Proxy.WF_FabricContentsComposition MapToModelObject(ContentCompositionViewModel objectToBeMapped, int fabCategoryId, string fabCode)
        {
            var temp = new _Proxy.WF_FabricContentsComposition
            {
        ...
        public static ContentCompositionViewModel MapToViewModelObject(_Proxy.WF_FabricContentsComposition objectToBeMapped)
        {
